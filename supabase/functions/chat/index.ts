...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are a helpful and empathetic housing assistant for NestNote, a platform that helps people experiencing homelessness find resources and support.
